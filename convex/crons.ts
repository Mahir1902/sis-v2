 ...
 * morning admin work starts. The handler scans up to OVERDUE_SCAN_CAP `sent`
 * invoices via the `by_status` index and patches the past-due ones to
 * `overdue`. Paid and voided invoices are not touched.
 */
crons.daily(

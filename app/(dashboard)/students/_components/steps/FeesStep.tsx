...
export function FeesStep() {
  ...
  const standardLevel = form.watch("standardLevel") as
    | Id<"standardLevels">
    | undefined;
  const academicYear = form.watch("academicYear") as
    | Id<"academicYears">
    | undefined;
      ...
      <div className="border rounded-xl p-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
            ...
            <p className="text-sm font-medium bg-slate-50 rounded-md px-3 py-2">
              {form.watch("studentNumber") || "—"}
            </p>
          </div>
          <div>
            <p className="text-sm font-medium text-muted-foreground mb-1">
            ...
            <p className="text-sm font-medium bg-slate-50 rounded-md px-3 py-2">
              {years?.find((y) => y._id === academicYear)?.name || "—"}
            </p>
          </div>
          <FormField
                  ...
                  render={({ field }) => {
                    ...
                    return (
                      <FormItem>
                        ...
                        {isAutoFilled && (
                          <p className="text-xs text-school-green">
